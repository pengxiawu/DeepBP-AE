...
H_beam_prox_sparse_syn = zeros(num_antennas, num_users*2);
for sample = 1:1:num_users
H_beam_prox_sparse_syn(:,sample*2-1) = real(H_beam(:, sample));
H_beam_prox_sparse_syn(:,sample*2) = imag(H_beam(:, sample));
end
...
% % save data
save('H_beam_prox_sparse_syn.mat', 'H_beam_prox_sparse_syn')
