...
2. Access the spatial channel vectors by running the Matlab Script "./dataset/load_dataset.m".

3. Transform the spatial channels to beamspace channels by running the Matlab Script "./dataset/channel_beamspace_tranform.m".
