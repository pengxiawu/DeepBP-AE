...
# model parameters
decoder_type = "SAE" # "choose one from [GAE, SAE]"
input_dim = 256 # "Input dimension [256]"
emb_dim = 32 # Number of measurements
...
checkpoint_dir = "./res/2021Nov_DeepMIMO_" + decoder_type  # Directory name to save the checkpoints [./res/]"
